...
{
    public class NotListedUnitsSelect:DataAccessBase
    {
        public NotListedUnitsSelect()
        {
           Command = StoredProcedure.Name.SP_LOADNOTLISTEDUNITS_FOR_SUPPLIES.ToString();
        }
        ...
        public void LoadNotListedUnitsForSupply(IList<Units> _GLists)
        {
