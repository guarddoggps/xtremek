...
{
    public class UnitPerPatternSelect:DataAccessBase
    {
        public UnitPerPatternSelect()
        {
           Command = StoredProcedure.Name.SP_SELECT_UNIT_PER_PATTERN.ToString();
        }

        public UnitPerPatternSelect(int _i)
        {
            Command = StoredProcedure.Name.SP_SELECT_PATTERN_UNITS.ToString();
        }
        ...
        public void selectUnitPerPattern()
        {
            try
            {
